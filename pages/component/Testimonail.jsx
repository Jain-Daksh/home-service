          ...
          <section className="mb-32 mt-24 text-gray-800 text-center">
            <div className="grid  md:grid-cols-3 gap-x-6 lg:gap-x-12">
              <div className="mb-12 md:mb-0">
                ...
                <h6 className="font-medium text-black-600 mb-4">lorem</h6>
                <p className="mb-4">
              ...
              <div className="mb-12 md:mb-0">
                ...
                <p className="mb-4">
                  ...
                  </svg>“We booked carpet cleaning for every room and got a nice discount. The carpets were cleaned very well and dried fast. All in all a good service.”
                </p>
                <ul className="flex justify-center mb-0">
                  <li>
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star" className="w-4 text-yellow-500"
              ...
              <div className="mb-0">
                ...
                <p className="mb-4">
                  ...
                  </svg>“It was very easy to book and arrange the service. The lady was on time and did a great job cleaning the stove.”
                </p>
                <ul className="flex justify-center mb-0">
                  <li>
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star" className="w-4 text-yellow-500"
